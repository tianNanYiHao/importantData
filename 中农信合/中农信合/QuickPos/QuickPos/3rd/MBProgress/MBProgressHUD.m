...
+ (void)showHUDAddedTo:(UIView *)view WithString:(NSString *)str;
{
 
    [view makeToast:str duration:2 position:@"center"];
    //[self.view makeToast:@"与服务器连接失败，请确定你的网络" duration:1 position:@"center"];
}
#pragma mark -
#pragma mark Class methods

+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated WithString:(NSString *)str {
