...
-(BoRefreshAnimation *)logoView{
    if (!_logoView) {
        BoRefreshAnimation *logoView = [[BoRefreshAnimation alloc] initWithFrame:CGRectMake(100, 100, 50, 50)
                                                                       grayImage:[UIImage imageNamed:@"33"]
                                                                        redImage:[UIImage imageNamed:@"22"]];
...
- (void)placeSubviews{
    ...
    self.stateLabel.center = CGPointMake(self.mj_w * 0.5, centerY + 25);
