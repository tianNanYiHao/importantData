...
typedef void (^SubLBXScanViewControllerBlock)(LBXScanResult *info);


//继承LBXScanViewController,在界面上绘制想要的按钮，提示语等
@interface SubLBXScanViewController : LBXScanViewController
@property (nonatomic,strong) SubLBXScanViewControllerBlock blocK;
...
#pragma  mark action
- (void)actionDoSomeThing:(SubLBXScanViewControllerBlock)blocK;
