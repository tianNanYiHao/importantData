...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace
                                                                                   target:nil
                                                                                   action:nil];
    UIBarButtonItem *constrainButton = [[UIBarButtonItem alloc] initWithTitle:PELocalizedString(@"尺寸筛选", nil)
                                                                        style:UIBarButtonItemStyleBordered
                                                                       target:self
                                                                       action:@selector(constrain:)];
    self.toolbarItems = @[flexibleSpace, constrainButton, flexibleSpace];
    self.navigationController.toolbarHidden = NO;//下方的按钮隐藏
...
- (void)constrain:(id)sender
{
    self.actionSheet = [[UIActionSheet alloc] initWithTitle:nil
                                                   delegate:self
                                          cancelButtonTitle:PELocalizedString(@"取消", nil)
    ...
    self.actionSheet.tintColor = [UIColor blackColor];
