...
@interface ITronAudioICVpos()<CSwiperStateChangedListener>
@property (nonatomic, strong)vcom *mVcom;
@end

@implementation ITronAudioICVpos
...
- (BOOL) readcard: (NSInteger) cmd data:(NSDictionary *)data {
    ...
    [mVcom stat_EmvSwiper:1 PINKeyIndex:1 DESKeyInex:1 MACKeyIndex:1 CtrlMode:ctr ParameterRandom:randomdata ParameterRandomLen:numRadomLen cash:cData cashLen:cashLen appendData:append appendDataLen:16 time:30 Transactioninfo:tranInfo];
