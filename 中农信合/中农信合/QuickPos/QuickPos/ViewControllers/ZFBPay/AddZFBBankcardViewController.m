//
//  AddZFBBankcardViewController.m
//  QuickPos
//
...
@interface AddZFBBankcardViewController ()<UITextFieldDelegate,ResponseData>{
...
@implementation AddZFBBankcardViewController
...
- (IBAction)addBankCard:(UIButton *)sender {
    ...
    //    }
        ...
        [request BankCardBind:[self.bankCardNumberTextField.text stringByReplacingOccurrencesOfString:@" " withString:@""] andMobile:@"" andBandType:@"06" bankName:item.bankName];
    }
