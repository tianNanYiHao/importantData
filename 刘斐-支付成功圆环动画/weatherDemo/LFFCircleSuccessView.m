...
@interface LFFCircleSuccessView(){
...
@implementation LFFCircleSuccessView
...
+ (instancetype)createCircleSuccessView:(CGRect)frame{
    ...
    LFFCircleSuccessView *rectView  = [[LFFCircleSuccessView alloc] initWithFrame:frame];    
    return rectView;
